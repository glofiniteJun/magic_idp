...
export function createApiKeyMissingError() {
    return new MagicAdminSDKError(ErrorCode.ApiKeyMissing, 'Please provide a secret Magic API key that you acquired from the developer dashboard.');
}
...
export function createAudienceMismatchError() {
    return new MagicAdminSDKError(ErrorCode.AudienceMismatch, 'Audience does not match client ID. Please ensure your secret key matches the application which generated the DID token.');
}
